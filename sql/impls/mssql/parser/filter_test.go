...
func Test_parseFilter(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			want:    "WHERE (email = @p1 AND age > 30 AND name LIKE @p2) GROUP BY (city, country) ORDER BY age ASC LIMIT 10 OFFSET @p3",
			want1:   []int{0, 2, 1},
			wantErr: false,
		},
		{
