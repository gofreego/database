...
func (u *Unimplemented) UpdateByID(ctx context.Context, record sql.Record, options ...sql.Options) (bool, error) {
...
func (u *Unimplemented) Upsert(ctx context.Context, record sql.Record, options ...sql.Options) (bool, error) {
